...
contract StarNotary is ERC721 {
    ...
    function createStar(string memory _name, string _symbol ,uint256 _tokenId) public { // Passing the name and tokenId as a parameters
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        // verify that the sender owns of the tokens

        if (msg.sender != ownerOf(_tokenId1) && msg.sender != ownerOf(_tokenId2)) {
            revert("You need to be the owner of the two tokens before you can exchange them");
        }

        // Getting the addresses of the two tokens
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerOf(_tokenId), "You must be the owner of the token");
